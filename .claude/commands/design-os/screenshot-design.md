...
The screen design URL pattern is: `http://localhost:3000/sections/[section-id]/[ViewName]`

1. First, use `browser_navigate` to go to the screen design URL
2. Wait for the page to fully load
3. **Click the "Hide" link** in the navigation bar to hide it before taking the screenshot. (If using the shell)
